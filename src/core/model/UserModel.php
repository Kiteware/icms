    ...
    public function buildMenu($parent)
    {
        ...
        if (isset($menu['parent_menus'][$parent])) {
            ...
            foreach ($menu['parent_menus'][$parent] as $menu_id) {
                ...
                if (isset($menu['parent_menus'][$menu_id])) {
                    $html .= "<li class=\"dropdown\"><a class=\"dropdown-toggle\" data-toggle=\"dropdown\" href='" . $menu['menus'][$menu_id]['nav_link'] . "'  aria-haspopup=\"true\" aria-expanded=\"false\">" . $menu['menus'][$menu_id]['nav_name'] . "<span class='caret'></span></a>";
